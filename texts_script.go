	...
	for _, match := range matches {
		...
		for _, line := range strings.Split(rawContent, "\n") {
			...
			if ok, _ := regexp.Match(`^\s*([0-9]+).+$`, []byte(line)); ok {
				...
				rxItalics := regexp.MustCompile(`_(.+)_`)
				line = rxItalics.ReplaceAllString(line, "<i>$1</i>")
...
1 Ke6!
     ...
     _This is now for White the ideal position in King and Pawn endings. He wins no matter whose move it is_
1 ...    Kd8
...
White wins
###4
WHITE wins this ending by getting the opposition, _and maintaining it_.
...
1 ...        Kf8
2 Kf6!
Best, since it maintains the opposition. White must resist the temptation to move closer to the Pawn. This would be the consequence: 2 Ke6, Ke8 3 d7+, Kd8 4 Kd6, and Black draws by stalemate. Note in this and similar positions that the Pawn must reach the seventh rank _without checking_ in order to win.
2 ...    Ke8
3 Ke6    Kd8
4 d7    Kc7
5 Ke7
...
1 Kd5    Kd7
2 Kc5
If Black could meet this by 2 ... Kc7, _he_ would have the opposition. This being impossible, he sets a little trap.
2 ...    Kd8
...
An endgame position worth remembering, since _White wins no matter whose turn it is to move._
...
White wins
###7
WHITE plays to get his King in front of the Pawn. The position is then a win, _no matter whose move it is_.
1 Kf7!
...
4 g6    Kg8
5 g7
The winning idea. The Pawn reaches the seventh rank _without checking_.
5 ...    Kf7
6 Kh7
...
White solves the problem by remembering that _one_ Pawn ahead is enough to win.
...
White wins
###14
THE isolated Pawns _look_ weak and helpless. They are perfectly safe. An attack on either Pawn is parried by advancing the other!
1 a4!
...
White wins
###18
_A STRAIGHT line is not the shortest distance between two points_.
...
###26
1 Kf5!
STARTING the Pawn instead would be premature: 1 a4, Ke4 2 a5, Kd5, and Black catches the Pawn.
1 ...         Ke3
...
7 b8=Q#
###32
WHITE has two ways of winning. One is to sacrifice the passed Pawn, get the opposition, capture Black's Pawn and march the Queen Pawn through. This is how it's done:

1 f6+        Kf8!

Better than 1 ... Kf7 2 Kf5, Kf8 3 Ke7 and it's all over.
2  f7!        Kxf7
If he refuses the Pawn by 2 ... Ke7, then 3 f8=Q+ forces 3 ... Kxf8 when 4 Kf6, Ke8 5 Ke6, Kd8 6 Kxd6, Ke8 7 Kc7 wins.
...
This wins for White no matter whose move it is. If it were Black's move, he would have to allow White's King to penetrate at his e7 or c7. Since it is White's move now, he can advance the Pawn to the seventh rank without checking and win.
10  Kc6    Kc8
Or 10 ... Ke7 11 Kf7 and the Pawn has a clear road.
11 d6    Kd8
12 d7    Ke7
13 Kc7 and wins
The second method is by triangulation:
If 1 ... Kf7 2 Kf5, Kf8 followed by 3 Ke6 is immediately decisive.
2 Kf4!
Not at once 2 Kf5 as after 2 ... Kf7 White must return to g5.
2 ...     Kg8
3 Kg4!
If 1 ... Kf7 2 Kf5, Kf8 followed by 3 Ke6 is immediately decisive.
2 Kf4!
...
2 ...     Kg8
3 Kg4!
White's King circles about, avoiding the square f5 except in reply to  ... Kf7.
3 ...    Kf8
4 Kg5    Kg8
5 Kg6    Kf8
6 f7    Ke7
...
The Pawn reaches the seventh rank _without checking_.
11 ... Kb7
12 Kd7
...
1 Kb7
If at once 1 d6, Kc8 2 d7+ (or 2 b6, cxd6 3 Kxd6, Kb7 drawing easily) Kd8 3 Kb7, Kxd7 4 Kb8, Kd6 and Black draws.
1 ...              Kd7
2 Kb8                  Kd8
...
10 e6+        Ke7
11 Ke5
The tempting 11 Kc6 (going after the Rook Pawn) is premature as Black takes the King Pawn _without loss of time_ (one tempo). The continuation would be 11 ... Kxe6 12 Kb7, Kd7 13 Kxa7, Kc7 14 Ka8, Kc8 and White cannot extricate his King, hence a draw.
11 . .        Ke8
12 Kd6        Kd8
13 Kc6
...
THE first step. White prevents 2 ... f6, after which the play would be 3 e6, Ke8 (on 3 ...  f5 4  Ke5 wins the Pawn) 4 Kd6, Kd8 5 e7+, Ke8 6 g4, Kf7 7 Kd7 and White wins. 
2 ...        Kd7 
3 Kd4!
Not at once 3 Ke4 as after 3 ... Ke6 4 Kf4, f6 5 exf6, Kxf6 6 Kg4, Kg6, Black has the opposition and draws.
White is triangulating in order to move his King to e4 _after_ Black plays ... Ke6.
3 ...        Ke7
4 Ke3        Kd7
5 Kf4
Threatening to invade at f5.
...
8 g4        Ke8!
9 Kf6!
White does not fall for the attractive 9 e6 after which 9 ... Ke7 10 exf7, Kxf7 11 Kg5, Kg7 gives Black the opposition and a draw.
9 ...        Kf8
10 g5
Here too 10 e6 is premature, as the continuation 10... fxe6 11 Kxe6, Kg7 12 Kf5, Kf7 lets Black draw easily.
10 ...        Ke8
11 Kg7!
Last chance for White to misplay it! If 11 e6, Kf8 12 e7+, Ke8 and White must concede the draw.
11 ...        Ke7
12 Kg8        Ke8
If 12 ... Ke6 13 Kf8, Kxe5 14 Kxf7 and White wins.
13 e6!
The point of the King's tour from b7 away over to g8.
13 ...        fxe6
14 g6        e5
15 g7        e4
16 Kh7        e3
17 g8=Q+
White wins. An exquisite ending even for Grigoriev, who created so many masterpieces of beautifully-timed play.
###47
...
6 Kxg1        Kg3
7 f5
White wins, as the Pawn cannot be headed off.
###60
1 Kc4!    Kxf4
...
###69
1 f4
TO THIS Black cannot reply 1 ...  Pd5 as after 2 f5, d4 3 f6, d3 4 f7, d2 White's Pawn promotes to a Queen _with check_, and wins.
1 ...        Kb4
2 h4
...
###89
CLEVER defense disposes of one White Pawn, but the one that remains renders Black's Knight _hors de combat_.
1 g6        Nd6
2 g7        Ne8
3 g8=Q        Nf6+
4 Kg5!        Nxg8
...
1 c7        Rd6+
2 Kb5
EVERY move of White's must be timed right. For instance, if 2 Kb7, Rd7 followed by capturing the pinned Pawn draws, or if 2 Kc5, Rd1 followed by 3 ... Rc1+ does likewise.
2 ...        Rd5+
3 Kb4        Rd4+
4 Kb3        Rd3+
5 Kc2        Rd4
...
1 ...    Kb5
If 1 ... Nc6+ 2 Kb6, Kd5   (or 2 ... Ne7 3 Kb7) 3 Nb4+, Nxb4 4 a7 and wins, or if 1 ... Kb5 2 Nd4! (a pretty sacrifice to prevent the King coming closer) Kxd4 3 Kb6, and White wins.
2 Nb4!    Ka5
...
1 ...        b2
2 a8=Q        b1=Q
With Black's King and Queen so far apart from each other, it seems incredible that the Queen will either be lost or the King driven into a _cul-de-sac_ in a half-dozen moves.
3 Qb7+        Ke6
...
3 ...           Ka6
4 Bh3                Ka5
Black may not move the Knight as after 4 ... Nb7, White can win the beast either by 5 Bc8 or 5 Bf1+.
5 Bg4
...
2 Bg7        Bb4
3 Bf8
Moving _in front of the Pawn_, even though it blocks the Pawn for the time being, to force Black's Bishop to leave the diagonal.
3 ...        Bd2
The second step:
4 Bc5        Bh6
...
6 Bg7
Now the Bishop moves _beside the Pawn_, assuring its advance next move.
White wins
###150
...
1 Be7
As in the previous example, White's first step is to move his Bishop _in front of the Pawn_. This will evict Black's Bishop from one diagonal.
1  ...        Be3
2 Bf8        Bg5
Black of course seizes the other diagonal leading to e7.
3 Bg7        Kd6
4 Bf6
The second step: the Bishop moves _beside the Pawn_ to dislodge Black from his occupancy of the critical diagonal.
4 ...         Bd2
...
###154
1 Bh4        Kb6
ON A Bishop move instead, say 1... Be5, White continues with 2 Bf6, Bh2 3 Bd4, Bg3 4 Ba7, Bf4 5 Bb8, Be3 6 Bh2, Ba7 7 Bg1, and wins.
2 Bf2+        Ka6
...
A] 1 g7, Be6+ 2 Kxe6, Kxg7, and Black draws against the Rook Pawn and a Bishop that does not control the Pawn's Queening square.
B] 1 Kf6, Be8 2 h4, Bxg6 3 Bxg6, and Black draws by stalemate.
...
7 f5        Ke8
8 f6
Note that White keeps his Pawns as much as possible _on squares opposite in color to those controlled by his Bishop_.
8 ...         Bc5
9 Kg7        Bf8+
10 Kg8        Bc5
11 e6        Bb4
...
4 g3+        Kf5
5 g4+
The Pawns, you will notice, occupy whenever possible squares _opposite in color to those controlled by the Bishop_. In this way, the Pawns and the Bishop dominate as many squares as possible. Here, for example, the Pawns attack the white squares, while the Bishop attacks the black.
5 ...         Ke6
If 5 ... Kf4 6 Bd2+, Kg3 7 g5, Be5 8 g6, Bg7 (otherwise 9 Bh6 followed by 10 g7 wins) 9 Ke3, Kh4 (clearly if 9 ... Bh6+ 10 Ke4, Bg7 11 Bf4+, Kg2 12 Be5 is decisive) 10 Ke4, Kh5 11 Kf5, Bd4 12 Bg5, Bg7 13 Bf6, Bf8 14 g7 wins.
...
A] 5 ... Ke6    6 Qe8+ winning the Queen.
B] 5... Ke4     6 Qe8+ winning the Queen.
C] 5 ...    Qe6    6 Qb3+ winning the Queen.  
D] 5 ...    Qe4    6 Qb7+ winning the Queen.
E] 5 ...    Qh4+ 6 Be7+ winning the Queen.  
F] 5 ...    Qg3 6 Bf2+  winning the Queen.  
G] 5...    Qc3 6 Bb4+  winning the Queen.  
H] 5 ...    Qd2 6 Qd7+  winning the Queen.  
I] 5 ...    Qh1 6 Qb7+  winning the Queen.  
J] 5 ...    Qd1 6 Qd7+  winning the Queen.  
K] 5 ...    Qc1 6 Be3+ winning the Queen.  
...
1 Rg8+       Kf3
2 Rh8       Kg4
FORCED, as the Pawn must be protected. Black's pieces are now back  to the position in the diagram, but White has gained time to place his Rook in the best possible position in Rook endings, _behind the passed Pawn_.
3 Kb2       h4
4 Kc2       h3
5 Kd2       Kg3
6 Ke2!       Kg2
...
A] 8 ... Na1 9 Re2, and to avoid mate, _Black must move the Knight, and lose it_.
B] 8 ... Kc1 9 Re2, and to avoid mate, _Black must give up his Knight at once_.
9 Re1+    Ka2
10 Re2+    Ka1
...
###199
AN ATTEMPT to drive the Rook off the Queen file could only succeed _if White's Pawn stood on the fifth rank_. Should White try it now, this would be the result: 1 Ke4, Re8+ 2 Kf5, Rd8 3 Ke5, Re8+ 4 Kd6, Rd8+ 5 Kc5, Rc8+, and White makes no progress.
...
Otherwise, White will continue with 10 Rg8, followed by 11 a8=Q.
...
But not 2 Kf5, Kf7 3 Re1, Ra1 4 Re2, Re8, and White cannot save his Pawn.
2 ...         Ra5+
3 Kf6        Ra6+
4 Kg5        Ra5+
...
3 ...        Kg2
4 Rxc6
_Now_ White exchanges, having forced Black's King to the Knight file.
4 ...        dxc6
5 g6        c3
6 g7        c2
7 g8=Q+
...
A] 3 ... Kc8 4 g8=Q+, Rxg8 5 Ra8+, and White wins the Rook.
B] 3 ... Kb7 4 c8=Q+, Kxc8 5 g8=Q+, Rxg8 6 Ra8+, and White wins the Rook.
4 Ra8
...
3 fxg7+        Rxg7
4 Kxh6        d1=Q
This seems to offer a glimmer of hope. Certainly there is none in 4 ... Rg8 5 Rh7#, nor in 4 ... Rxf7 5 gxf7, and Black's King must wait for the _coup-de-grace_.
5 Rf8+        Rg8
6 g7#
###242
...
Or 5 ... Ka1 6 Qc1#.
6 Kd1!        a1=Q
If 6 ... a1=N 7 Qb4+, Ka2 8 Kd2, Nb3+ 9 Kc3, Ka1 (a Knight move instead allows 10 Qb2#) 10 Kxb3 (definitely not 10 Qxb3) Kb1 11 Qe1#.
7 Qc2#
###248
...
11 Qf2#
###251
THE safest place for the Rook, in endings of Queen against Rook, is close to his King. Once out in the open, the Rook is no match for the fleet-footed Queen.
In the diagrammed position, the Rook is in no danger. White's object therefore is to force the Rook away from the protection of the King, _to any other square_ in fact, where it will be exposed to the threat of capture.
White accomplishes his object by playing three moves which bring about the position in the diagram, but _with Black to move_.
1 Qd4+        Ka8
The King must move to the last rank, since 1 ... Ka6 allows 2 Qa4#.
2 Qh8+        Ka7
Again forced, the reply to 2 ...     Rb8 being 3 Qa1#.
3 Qd8
_Now White has the desired position, with Black to move_.
Black, as we shall prove, has no moves that do not lose the Rook or expose him to mate.

_If he moves the King_:
A] 3 ... Ka6    4 Qa8+, Ra7 5 Qb8, and Black will shortly be mated, e.g. with 5 ...  .Ka5 6 Qb5#.
_If he moves the Rook along the file_:
A]    3 ... Rb8 4 Qa5#
B]    3 ... Rb6+ 4 Qxb6+, and mates next move with Qb7#
C]     3 ...  Rb5 4 Kxb5
D]    3 ...  Rb4   4 Qa5+, winning the Rook
E]     3 ... Rb3 4 Qd4+, Kb8 (on 4 ... Ka8 5 Qa4+ wins the Rook) 5 Qf4+, Ka8 (on 5...   Kc8 6 Qf8#) 6 Qa4+, and White wins the Rook
F]    3 ... Rb2 4 Qd4+, and White wins the Rook
G]    3 ... Rb1 4 Qd4+, Ka8 (on 4 ... Ka6 5 Qa4#) 5 Qh8+, Ka7 (or 5...  Rb8 6 Qa1#) 6 Qh7+, and Black loses his Rook
_If he moves the Rook along the rank_:
A]    3 ... Rc7    4 Qxc7+ wins
B]    3 ... Rd7    4 Qxd7+ wins
C]    3 ... Re7    4 Qxe7+ wins
D]    3 ... Rf7    4 Qd4+, Ka8 (if 4 ... Ka6 5 Qa4#) 5 Qa1+, Kb8 (on 5 ... Ra7 6 Qh8#) 6 Qb2+, Ka8  (if 6 ... Kc8 7 Qh8+ and mate next move, or if 6 ... Ka7 7 Qa2+ wins the Rook) 7 Qa2+ (attacks the Rook) Ra7 8 Qg8#
E]    3 ... Rg7 4 Qd4+ and White wins the Rook 
F]    3 ... Rh7 4 Qd4+, Kb8 (if 4 ... Ka8 5 Qa1+, Kb8 6 Qb1+ wins the Rook) 5 Qb4+, Ka7 6 Qa4+, Kb8 7 Qb3+, Ka7 8 Qa2+, Kb8 9 Qg8+, and White wins the Rook
Q.E.D.
White wins
###252
...
2 ...        Kxh1
3 a8=Q
Threatens quick mate by 4 Kg3+ (or by 4 Kf2+) followed by 5 Qg2#.
3 ...        Kh2
This is what happens on other Black defenses:
A] 3 ... Qd3+ 4 Kf2+, Kh2 5 Qg2#
B] 3 ... Qf1+ 4 Kg3+, Kg1 5 Qa7+, Kh1 6 Qh7+, Kg1 7 Qh2#
C] 3 ... Qh4 4 Qa1+, Kh2 5 Qb2+, Kg1 6 Qg2#
D] 3 ... Qc2 4 Kg3+, Kg1 5 Qa1+, and mate next after taking the Queen.
E] 3 ... Kg1 4 Qa7+, Kh1 5 Qh7+, Kg1 6 Qg6+, Kf1 (or 6 ... Kh2 7 Qg2#) 7 Qb1+, Qc1 8 Qxc1#
4 Qh8+        Kg1
5 Qg7+        Kf1
6 Qa1+        Qc1
7 Qxc1#
...
1 ...     Qg4+
Checking instead at g8 or h8 instead allows 2 e8=Q in reply.
2 Kb8    Qb4+
3 Ka8
The King is safe from checks here in spite of his apparently exposed position! If Black should try 3 ... Qa4+ or 3 ... Qa5+ 4 Qa7 in reply will force the Queens off the board, leaving the King/Pawn pair as the surviving victor.
White wins
###256
TO WIN this, White must promote his Pawn. He would then have the overwhelming advantage of two Queens against one.
Two problems must be solved: Advancing the Pawn (which is now pinned) and safeguarding his King from perpetual check (which would give Black a draw).
1 Kh7        Qh1+
If 1 ... Qd7 instead (to renew the pin) 2 Qe4+, Kc5 3 Kg8, and Black cannot pin the Pawn (3 ... Qd5 4 Qxd5+ wins for White) nor check advantageously (3 ... Qd8+ 4 f8=Q+)
2 Kg7!        Qa1+
3 Kg8        Qa2
4 Qb6+        Kc3
The only move, since 4... Ka4 or 4 ... Ka3 allows 5 Qa6+ with an exchange of Queens, while 4 ... Kc4 5 Qe6+ wins the Queen outright.
5 Kg7!        Qg2+
6 Qg6        Qb7
7 Kg8        Qd5
Obviously 7 ... Qc8+ is useless after 8 f8=Q in reply, while the pin by 7... Qb3 fails after 8 Qg3+, forcing the exchange of Queens.
8 Kh7        Qh1+
On 8... Qd7 pinning the Pawn, 9 Qg7+ cleverly unpins it.
9 Qh6        Qe4+
10 KhR8    Qe5+
11 Qg7
Black must exchange Queens, and White wins.
###257
WHITE'S win depends on Queening his Pawn. The manner in which the Pawn is freed from the pin (which now prevents its advance) is rather startling.
1 Qb4
Immobilizes Black's King, and forces his Queen to move.
1 ...        Qh1
The Queen stays on the long diagonal to maintain the pin. There are other squares on this diagonal which the Queen could have chosen with the following results:
A] 1 ... Qd5 2 Qa4+, Kb6   3 Qb3+!, Qxb3 4 b8=Q+, and      White wins the Queen
B] 1 ... Qg3 2 Qa4+, Kb6 3  Qb3+, Qxb3 4 b8=Q+, and   White wins the Queen
C] 1 ... Qg2 2 Qa3+, Kb6 t3 (or b5) 3 Qb2+, Qxb2 4 b8=Q+ and White wins
...
C] 3 ... Kc7 4 Qh2+, Qxh2 5 b8=Q+, and White wins the Queen.
4 Ka7        Qh7
Black has no check, so he clamps on a new pin.
5 Qb6+        Kd5
On 5 ... Kc4 instead, 6 Ka6 followed by Queening the Pawn wins.
6 Ka6
Leaves Black powerless to stop the Pawn's advance. If he tries 6... Qd3+, the response 7 Qb5+ forces an exchange of Queens (if of course 7 ... Kd4).
White wins
###258
1 Qg2+        Kf8
IF BLACK plays 1 ... Kh8 instead, then 2 Qa8+, Qg8 3 Qa1+ and mate next move.
2 Qa8+        Qe8
3 Qb7
Threatens to mate at g7. 
3 ...     Qd8
On 3 ... Qf7 4 Qc8+, Qe8 5 d7 is decisive, while 3 ... Qa4 is penalized by 4 Qg7+, Ke8 5 Qe7#.
4 Kg6        Qe8+
5 Kf6        Qd8+
6 Kxe6        Qe8+
Running away to escape mate leads to this: 6 ... Kg8 7 Qf7+, Kh8 8 Qf6+, and with Queen swap, White wins.
7 Qe7+        Qxe7+
8 exd7+        Ke8
9 Kf6
White wins
###259
1 Qb1
A QUIET move, but it threatens to win by 2 Qb5+, Kd4 3 Qd5#.
1 ...         Kd4
2 Qb3!
Clearly indicating his intention 3 Qd5#. There is more to White's move though than this trans parent threat. Note that he lets Black defend by capturing a Pawn with check!
2 ...         Qxe4+
3 Kd6
Black must now guard against 4 Qc3#.
3 ...        Qa8
The Queen moves away to give the King a flight square. She must stay on the long diagonal to prevent 4 Qd5#, but was any square besides a1 available?
If 3 ... Qg2 or 3 ... Qh1 instead, 4 Qc3+, Ke4 5 Qc6+, and White wins the Queen.
4 Qe3+        Kc4
5 Qc3+        Kb5
6 Qb3+        Ka6
Obviously 6 ... Ka5 7 Qa3+ costs the Queen.
7 Qa4+        Kb7
8 Qb5+        Ka7
...
1 Qc1+        f4
The only defense. The King may not move to the Rook file, as the reply 2 Qh1+ wins his Queen, while on 1 ... Kg6 2 Qg1+, Kh6 3 Qh2+, Kg7 4 Qg3+, Kh6 5 Qh4+, Kg7 6 Qg5+, Kh7 7 Kf7!, and Black faces mate.
2 Qg1+        Kf5
Here too, moving to the Rook file is fatal.
3 Qg4+        Ke5
4 Qg5+        Kd4
5 Qg1+        Ke5
Forced, since 5 ... Kc3 loses the Queen after the reply 6 Qa1+.
6 Qa1+
Will White win the Queen?
6 ...     d4
No, he will not, but . . 
7 Qxa5
Mates the King!
###261
1 Qf7+        Qf5
THE King must not move, since  1 ... Kg4 allows 2 Ne5+ winning the Queen by a Knight fork, while 1 ... Ke4 2 Qg6+ wins the Queen by the skewer attack.
2 Qc4+        Qe4
3 Qc7+        Kf5
On 3 ... Kg4 4 Qg7+ leads into the main line of play after White's fifth move.
4 Qf7+        Kg4
5 Qg7+        Kf5
The only square left to the King. If:
A] 5 ... Kh5 6 Qg5#
B] 5 ...  Kh3  6 Qg3#
C] 5 ... Kf4  6 Qg5#
6 Nd4+        Kf4
7 Qg3#
###262
WHITE'S tactical play is artistic but no less incisive.
1 Qg4+        Ke5
The only flight square, 1 ... Kd3 costing the Queen after 2 Qe2+.
2 Qg5+        Ke4
Here if 2 ... Kd6 3 Qf6+ wins the Queen, while 2 ... Kd4 runs into 3 Qe3#.
3 Bg6+        Kd4
4 Qe3+        Kd5
Or 4 ... Kc4 5 Qd3+, and White wins the Queen.
5 Be4+!
After this powerful move, Black can only decide in what manner his Queen will be lost. If he plays 5 ... Kd6 (or Ke6) 6 Qh6+ wins the Queen on the rank. If he moves 5 ... Kc4 6 Bd3+ wins the Queen on the diagonal, while 5 ... Ke5 6 Bb7+ (or Bd3+) wins the Queen by discovered attack.
White wins
###263
EVERY player from Grandmaster, down, to whom I showed this ending picked 1 Kd7+ as the first move in the solution. It does not win, though it would seem that the King should move in towards Black for the kill.
The winning line of play:
1 Kb7+!        Kh7
2 Qh2+        Kg8
3 Qa2+        Kh7
Obviously, 3 ... Kf8 instead is unsuitable, the reply 4 Qa8+ costing Black his Queen.
4 Qf7!
Decisive! Black is tied hand and foot. Neither King nor Pawn may move, while his Queen is restricted to one square. Note how White's first move by the King gave him control of three squares on the last rank.

4 ...        Qg8
5 Qh5#!
###264
1 Qf1
THREATENS a killing discovered attack, thus: 2 Nd3dis.ch Qb2 3 Qf6+, Qb2 4 Qxb2#.
1 ...        Qb1
The only possible defense. Other tries lose as follows:
A] 1 ...  Kb2     2 Nd3+
B] 1 ... Kb1     2 Nd3 dis.ch
C] 1 ... Qc3+     2 Nd3 dis.ch
D] 1 ... Qa3+     2 Nd3 dis.ch
In all the above, White either wins
the Queen or forces mate.
2 Qf6+        Qb2
3 Nb3+        Kb1
4 Qf1+        Kc2
5 Na1+!        Kd2
On 5 ... Kc3 instead, 6 Qf6+ wins the Queen
6 Qf2+        Kc3
Or 6 ... Kc1 7 Qel#.
7 Qf6+
White wins the Queen and the game.
###265
SKILLFUL maneuvering of Queen and Knight brings about a problem-like mating position.
1 Qb6+        Kc4
2 Qd4+        Kb3
If 2 ... Kb5 instead, 3 Na7+ forces the King away from his Queen.
3 Qd1+        Ka3
4 Qa1+        Kb3
5 Nxa5+        Kb4
6 Qd4+        Ka3
Taking the Knight (6 ... Kxa5) or Kb5 allows 7 Qb6#.
7 Nc4+        Kb3
The only move, 7 ... Ka2 running into mate on the move, (i.e.8 Qb2#) while 7 ... Kb4 costs the Queen after 8 Nb6 dis.ch.
8 Nd2+        Ka3
9 Qa1+        Kb4
10 Qb2+        Kc5
Black of course avoids 10 ... Ka5 11 Qb6#.
11 Qb6+        Kd5
12 Qd6#, and a pretty mate it is.
###266
1 Qa1+        Kb4
FORCED, as 1 ... Kb3 loses the Queen by a Knight fork.
2 Qb2+    Ka4
Alternative moves by Black lead to this:
A] 2 ... Ka5 3 Qa3+, Kb6 (or 3 ... Kb5 4 Nd4+) 4 Qa7+, Kc6 (or Kt4) 5 Nd4+, and White wins the Queen.
B] 2 ... Kc4 3 Qc3+, Kd5 (3 ... Kb5 4 Nd4+) 4 Qa5+, Ke4 (on 4 ... Ke6 5 Nd4+ wins) 5 Ng3+ wins the Queen
C] 2 ... Kc5 3 Qa3+, Kc4 (if 3 ... Kc6 or Kb5 4 Nd4+ wins) 4 Qc3+, and White wins as in variation B] above
3 Nc3+    Ka5
4 Qa3+    Kb6
5 Qd6+    Ka5
6 Kb8!!
...
6 Qxd5+        Kc3
If 6 ... Kb4 instead, 7 Qa2! sets Black an impossible problem (the hardest kind to solve). If he moves his King (7 ... Kc3) then 8 Nd5+ wins the Queen, while should he move his Queen, 8 Nd5 mates the King.
7 Qa8!
Threatens 8 Nd5+ winning the Queen.
7 ...    Kd4
The King moves, since the Queen must stay put.
8 Nd5 
White wins the Queen.
###268
PIECES are even, but Black’s crowded position suggests the possibility of a White win.
1 Kh4!
The King must find a quiet place, away from annoying checks.
1 ...         Qa4+
As good as there is, 1... Qb1 losing the Queen after 2 Ra8+, and 1 ... Kb1 2 Qe1+ leading into the main line of play.
2 Kg3        Qa2
The Queen must return to protect the Rook, but not to c2 then 3 Ra8+, Kb1 4 Qe1+, Qc1 5 Ra1+, Kxa1 6 Qxc1+ is too expensive.
3 Qe1+        Rb1
The alternative 3 ... Qb1 leads to 4 Qa5+, Qa2 5 Qc3, Kb1 6 Qe1+, and the procedure is the same as in the main line of play.
4 Qe5+        Rb2
5 Qc3        Kb1
     Forced, as 5 ...  Qb1 6 Ra8+ costs the Queen.
6 Qe1+    Kc2
7 Rc8+    Kd3
On 7 ... Kb3 8 Qc3+, Ka4 9 Ra8+ wins the Queen.
8 Rc3+
Begins a series of checks given by Rook and Queen alternately on the Black squares, which drives the un happy King upward to his doom.
8 ...        Kd4
9 Qe3+    Kd5
10 Rc5+    Kd6
11 Qe5+    Kd7
...
1 ...        Kc4
2 Qa2+        Kb5
Quick disaster follows 2 ... Kd3 when 3 Qe2+, Kc3 4 Qc2 mates the King.
3 Qb3+        Kc6
The alternative is 3... Ka5  when 4 Qb4+, Ka6 5 Qa4+, Kb7 6 Qb5+, Ka8 (or Kc8) 7 Qa6+, Kb8 8 Qa7+, Kc8 9 Qa8#.
4 Be7!        Qxe7
5 d5+        Kd6
6 Qb4+        c5
7 dxc6 e.p.+    Ke6
8 Qxe7+    Kxe7
9 c7
Nothing can stop the Pawn, who has led a charmed life, from becoming a Queen next move.
White wins
###270
BLACK'S King and Queen are far apart, yet White manages to involve them in a combination resulting in loss of the Queen or worse.
1 Nc2+        Ka4
Not to a2 as 2 Qa3 is mate.
2 Qg4+        Kb5
The King avoids two pitfalls: 2 ... Kb3 3 Qb4+ and mate next, and 2 ... Ka5 3 Qb4#.
3 Nd4+        Kb6
The only flight square. Moving to any other Black square (e.g.c5) permits a Knight fork impaling King and Queen, while returning to the fifth rank exposes the King to a discovered check by 4 Ne6, costing the Queen.
4 Qg6+        Kb7
Black is given no choice. If 4 ... Kc7 (or Kc5) 5 Ne6+ wins the Queen, and if 4 ... Ka7 (or Ka5)
5 Nc6+ does the trick.
5 Qe4+!        Kc8
If Black tries 5 ... Kb6 instead, 6 Qb1+ forces the King to one of the fatal Black squares. It’s been a Knight’s heaven.
6 Qa8+        Kd7
7 Qc6+        Ke7
8 Qe6#!
###271
1 Qa4+        Kc5
ON 1 ... Kc3 instead, 2 Qa1+, Kd3 3 Ne5+, and Black must give up his Queen.
2 Qa7+        Kd5
3 Ne3+        Ke5
4 Qg7+        Kf4!
The best chance. On 4 ... Nf6   5 Kg6 (to win the pinned Knight) Qd8 6 Nc4+, Kd5 (leaves the Knight to its fate, but 6 ... Ke6 runs into 7 Qf7#) 7 Qxf6, and White wins.
5 Ng2+!
But not the hasty 5 Qxd4, and Black draws by stalemate.
5 ...        fxg2
6 Qxd4        g1=Q
By ingenious play Black has replaced the Queen he lost with a new Queen, but White is prepared for even this contingency.
7 Qe3+     Ke5
On 7 ...     Kg4 instead, 8 f3+ wins the Queen.
8 f4+
White wins the second Queen and the game.
###272
THE Queen wins this almost by herself, with a delightful series of zigzag checks.
1 Qf5+    Kh8
The only move, since 1 ... Qg6 loses the Queen by 2 Nf8+, and 1 ... Kh6 exposes the King to mate in three, starting with 2 fxg5+.
2 Qe5+        Kh7
3 Qe4+        Kh8
4 Qd4+        Kh7
5 Qd3+        Kh8
...
8 Qb2+        Kh7
9 Qb1+        Kh8
Now the Queen takes three giant steps for the denouement.
10  Qh1+        Qh7
11 Qa1+        Kg8
12 Qa8+        Kf7
13 Nxg5+
White wins the Queen and the game.
###273
A CAPTIVATING bit of endgame magic:
1 Ne4        Nd3
Black avoids Queening with check. the reply 2 Nf2+ forcing him to give up his Queen at once.
2 Qf2!        Nxf2
If instead 2 ... g1=Q, pinning White's Queen, 3 Ng3+. Qxg3 4 Qxg3 wins for White.
3 Ng3+!    Kg1
4 Ng5
Holds the King fast, and restricts Black to moves by one of the Knights.
4 ...        Ng4
...
1...        Ne4
Black had no time to get his King into the open, his Knight being attacked, but the Knight might have moved to f3 instead with this result: 1 ... Nf3 2 Ke7, Nh4 3 Kf7, Nf5 4 Kf8, Nxh6 5 Nd6, and White's next move will be 6 Nf7# since Black’s Knight has been chased out.
2 Kd7!
This, and not e7 is the right square for the King. On 2 Ke7 instead, the reply 2 ... Kg8 prevents White from making further progress.
Now if Black plays 2 ... Kg8 3 Ke7, Ng3 4 Nf6+, Kh8 5 Kf7 forces mate.
2 ...         Nf6+
Hoping for 3 Nxf6 and Black draws by stalemate.
3 Ke7        Ng8+
If 3 ... Nxe8 instead, 4 Kf8!, Nd6 5 Bg7#.
4 Kf8!        Ntxh6
5 Nd6        Nf5
6 Nf7#
###275
A BEAUTIFUL ending! White toys with his opponent (even forcing him to Queen a Pawn) while evolving a picturesque mate.
1 Be3+  Kb1
2 Bh6  b5
3 Ke7  b4
4 Kf6  b5
...
###276
1 e7        Rh8
THE Pawn cannot be stopped by 1 ... Re5, as 2 Nc4+ wins the Rook.
2 Ne6
Intending 3 Nf8 next, cutting off the Rook.
2 ...        Re8
If 2 ... Rc8, White does not play 3 Nd8 as 3 ... Rc3+ 4 Kb2, Rxe3 draws, but 3 Nc4+, Ka6 4 Nd8, which wins.
3 Nc7!
The move that does the trick. White must not be seduced by the attractive 3 Nc4+, Kb5 4 Nd6+!, Kc6 5 Nxe8, when Kd7, followed by  6 ... Kxe7 allows a draw (the two Knights alone being unable to force mate) nor by 3 Nc4+, Kb5 4 Nc7+, Kc6 5 Nxe8, Kd7, and again Black draws by capturing the Pawn.
3 ...        Rxe7
4 Nc4#!
###277
GIVEN a chance, the Bishops can swoop down the diagonals, and come up with a Queen in their clutches.
1 b3+		Kb5
On 1 . . Kb4, the skewer attack 2 Bd2+ wins the Queen, while 1 ... Ka3 is refuted by 2 Bc1+, Ka2 3 b4+, and again White wins the Queen.
2 Be8+		Kc5
Clearly, 2... Kb6 loses the Queen at once by 3 Bd8+.
3 b4+!		Qxb4
The alternative is 3 ... Kxb4 4 Bd2+.
4 Be7+
White wins the Queen and the game.
###278
AN ASTONISHING ending, with all sorts of attack and counter-attack. Both sides indulge in surprise tactical play.
1 f7
White does not start with 1 Bb2, as the response would not be 1... Bxf5 2 f7+, and White wins, but simply 1... Rxf6 when 2 Bxf6+, Kh7 leaves nothing but a draw.
1... 		Ra6+
Black loses after 1 ... Re6 by 2 Bb2+, and after 1 ... Rg8 by 2 fxg8=Q+, Kxg8 3 Ne7+ followed by 4 Nxc8.
2 Ba3!
Not 2 Kb1, Bxf5+ followed by 3... Kg7, nor 2 Kb2, Rf6, and White cannot pin the Rook.
2 ... 		Rxa3+
3 Kb2		Ra2+!
To which White must not play 4 Kxa2 as 4... Be6+ wins the Pawn and draws.
4 Kc1!		Ra1+
5 Kd2
If 5 Kb2 instead, then 5 ...    Rb1+ 6 Kc3, Rb3+ 7 Kd4, Rd3+ 8 Kxd3 (on 8 Ke5, Rd8 draws easily) Bxf5+ 9 Kd4, Kg7, and Black has a draw.
5 ... 		Ra2+
6 Ke3		Ra3+
7 Kf4		Ra4+
8 Kg5
Bad for White would be 8 Ke5. Ra5+ followed by 9... Rxf5 and Black wins, while 8 Kf3 is met by 8... Bb7+ and 9... Ra8.
8...		Rg4+!
9 Kh6!
Best, the alternatives being:
A] 9 Kxg4, Bxf5+ 10 Kxf5, Kg7 Ke6, Kf8 12 Kf6, and Black is stalemated.
B] 9 Kh5, Rg8 10 Ne7, Rf8 11 Ng6+, Kg7, and Black draws.
9 ...		Rg8!
Cleverly avoiding 9 ... Rg6+ 10 Kxg6, Bxf5+ 11 Kh6, and the Pawn will Queen.
10 Ne7
Threatens 11 fxg8#.
What does Black do now? If the Rook moves on the rank (say to f8 or d8) 11 Ne6#; if it moves on the file, the Pawn promotes to a Queen and forces mate.
10 ...		Be6
Ingenious to the last. If White plays 11 Ng6+, then 11... Rxg6+ 12 Kxg6, Bxf7+ gives Black a draw.
But White has a last trump:
11 fxg8=Q+	Bxg8
12 Ng6#!
###279
WHITE seems to have a weak and somewhat scattered little army with which to put up a successful fight against the powerful Queen, but we shall see...
1 Nb6+        Kc7
If 1 ... Kd8 instead, 2 Bg5, Qxg5 3 f8=Q+, Kc7 4 Qc8+, Kxb6 (or 4... Kd6 5 Qc5+, Ke5 6 d6+, Kf6 7 Qxg5+ wins) 5 Qc5+, Ka6 6 Qa5#.
2 f8=Q!
The tempting 2 d6+ fails after 2 ... Qxd6 (not 2... Kxd6 3 Bc5+ and White wins both Queen and game.) 3 Bc5 (expecting 3... Qxc5 4 Nd5+) Kd8! 4 Bxd6, and Black draws by stalemate.
2 ...        Qxf8
3 d6+        Kc6
Other possibilities are:
A] 3 ... Qxd6 4 Bf4, Qxf4 5 Nd5+, and White wins Queen.
B] 3 ... Kb8 4 Nd7+, and White wins the Queen
C] 3 ... Kd8 4 Bg5+, Ke8 5 d7+, Kf7 6 d8=Q, and White has a winning advantage.
4 b5+        Kxd6
5 Bc5+        Kxc5
6 Nd7+
White wins the Queen and the game.
###280
1 Rc2+		Kb3
THE alternative 1 ... Kb1 leads to this: 2 Ne2, a1=Q 3 Nc3+, Qxc3+ 4 Kxc3, a2 5 Rb2+, Ka1 6 Rh2, Kb1 7 Rh1#.
2 Rc1		a1=Q!
The best chance. If instead 2 ... Kb2 3 Kd2, a1=Q 4 Nd3+, Ka2 5 Nb4+, Kb2 6 Rxa1, Kxa1 7 Kc1, a2 8 Nc2#.
3 Rxa1		Kb2
4 Rf1!
This is the key square for the Rook, as will later be seen.
4 ...		a2
5 Kc4!
Clears d3 for the use of the Knight.
5 ...		a1=Q
6 Nd3+		Ka2
7 Nb4+		Kb2
8 Rf2+		Kb1
If 8 ... Ka3 instead, 9 Nc2+ wins the Queen, or if 8 ...Kc1 9 Na2+, Kb1 (or 9 ... Kd1 10 Rf1+) 10 Kb3, and Black is lost.
9 Kb3
Black has no defense against the threat of 10 Rf1 mate. Had the Rook gone to Kg1 at the fourth move, Black's saving move now would be 9... Qa7, while had the Rook moved to h1, the defense  9 ... Qa8 would prevent mate.
As it is... .
White wins
###281
BLACK has two threats which must be taken into account: 1... h8=Q and 1 ... Bxa6.
1 Rg8+	Kb7
If 1 . . Kd7 2 Nb8+ followed by 3 Kxh2 wins.
2 Nc5+	Kb6
Black must keep on attacking the Knight diagonally. Against 2 ... Kc6 instead, White plays 3 Rc8+ followed by 4 Kxh2.
3 Na4+	Kb5
Here too if 3 ... Ka5, the reply is 4 Ra8+ and 5 Kxh2.
4 Nc3+           Kb4
5 Na2+           Kb3
6 Nc1+           Kb2
7 Kxh2           Kxc1
...
White pins the Bishop and wins.
###282
1 Ne8+		Kc8
OTHER moves lose the Rook: 1... Kd7 2 Rb7+, or 1 ... Kd8 2 Rb8+ followed by 3 Rb7+.
2 Nd6+		Kd8
3 Rb8+		Kd7
4 Rb7+		Kd8
Hoping that White will grab the Rook without realizing that it leaves Black stalemated.
5 Nf7+		Kc8
The alternative is interesting: 5 ... Ke8 6 Ke6 (threatens 7 Rb8#) Kf8 7 Kf6, Ke8 8 Re7+, Kf8 9 Rd7, Kg8 (or 9 ... Ke8) 10 Rd8#
6 Kc6		Rg7
The Rook must stay on the second rank. If for example, 6 ... Rh4, then 7 Nd6+, Kd8 8 Rd7#.
7 Nd6+		Kd8
8 Rb8+		Ke7
9 Nf5+		Kf6
10 Nxg7
White remains a Rook ahead, and wins.
###283
THE setting is simple, but there is a wealth of ideas in this remarkable ending.
1 Rh8+		Kd7
On 1 ... Ke7 instead, the Knight fork 2 Nc6+ wins at once.
2 Rh7+		Kd6!
Angling for 3 Rxa7 and stalemate.
3 Nf7+		Kc7
...
5 Nc4+		Ka6
6 Rh6+		Kb7!
On 6... Kb5 instead, White finishes by 7 Rb6+, Ka4 8 Kc3 (threatens 9 Rb4#) Rb7 9 Nb2+, (definitely not 9 Rxb7 stalemate) Ka5 10 Rxb7, and White wins.
7 Nd6+		Kb8
Here if 7 ... Ka8 8 Rh8 is mate, while should the King move to a6, b6 or c6, the reply 8 Nc8 (discovering check while attacking the Rook) wins for White.
8 Rh8+		Kc7
9 Nb5+
...
###284
1 Ra1+		Ke2
THE only move, 1... Kc2 costing the Rook after 2 Ne3+.
2 Ng3+	hxg3
3 Ra2+!
Brilliant! It's hard to resist 3 Rxh1 only to find there is no win after Black moves 3... g2 in reply.
3 ... 		Kd1
4 Kd3		Ke1
If 4 ... Kc1 5 Ra1+ wins Rook and game.
5 Ke3
White insists on threatening mate. 5 ...		Kf1
Black loses after 5 ... Kd1 by 6 Ra1+ followed by 7 Rxh1
6 Kf3		Kg1
7 Kxg3		Kf1
8 Ra1+
...
1 Bb3+	Ke5
The King had choice of other squares, with these continuations:
A] 1 ... Kd6 (or c6) 2 Rg6+ winning the Knight
B] 1 ... Kc5 2 Be6 (prevents the Knight from coming out) followed by 3 Rg6, winning the beast
C] 1 ... Kd4 2 Kc2, Bc3 3 Rd1+, and White wins the Bishop
D] 1 ... Ke4 2 Rg6, Nf5 3 Bc2+, Ke5 4 Rg5, pinning and winning the Knight
2 Kc2	Bd4
3 Rg6	Nf5
The Knight and Bishop have managed to save themselves, but in doing so betray their King. White's next move is... .
4 Re6#!
###288
1 Kb4
BOTH of Black's pieces are now threatened. White could not play 1 Rxf3 at once, as the reply 1 ... Nd4+ would cost his Rook.
1 ...		Nd4
Protecting the Bishop, but should the Bishop instead try to protect the Knight, this happens: 1 ... Bd5 2 Rd1, Bg8 3 Bc4, Bxc4 4 Kxc4. Na5+ 5 Kb5, Nb7 (or 5 ... Nb3 6 Kb4 winning the Knight) 6 Kb6, and the Knight is lost.
2 Kc3		Be2
3 Bxe2		Nxe2+
4 Kd3		Ng3
The only square open to the Knight.
5 Rf3		Nh5
If 5... Nh1 6 Ke2, h5 7 Rh3 wins the Knight.
6 Rf5		Ng7
If instead 6... Ng3 7 Rg5, Nf1 (or 7 ... Nh1 8 Ke2, and the Knight is surrounded) 8 Rg2, and White's next move 9 Ke2 attacks and wins the Knight.
7 Rf8#!
###289
1 a3!
SURPRISING, but it is more important to retain the Pawn (a potential Queen!) than to save the Bishop. Had White played 1 Rf3 instead, the continuation 1 ... Kxa1 2 Rxf5 leaves him a piece ahead, but with no win in sight.
1  ...		Rxf1+
2 Ke2		Rf4
Forced; if 2 ... Rh1 instead,   3 Rd1+, Rxd1 4 Kxd1, and White wins, his Pawn being beyond pursuit, while Black's can never get through. Or if 2 ... Kc2 3 Rd2+!, Kc3 4 Kxf1, Kxd2 5 a4, and White wins easily.
3 Rb3+		Kc2
4 Rb4!		Rxb4
No better is 4... Re4+ 5 Rxe4, fxe4 6 a4, and White wins.
5 axb4
...
2 Nf7+		Kxh5
If instead 2 ... Kg7 3 Ng5+,  Kg8 (or 3 ... Kf8 4 Rf7+, Ke8 5 Ke3, and Black Pawn is lost) 4 Re8+, Kg7 5 h6+, Kg6 (5 ...  Kxh6  6 Rh8+  and  7 Rh1 or 5 ... Kf6 6 Re6#)  6 Kg4, f1=Q 7 Re6+, Qf6   8 Rxf6+, Kxe6 9 Kh5!, and Black   is helpless to stop the Pawn.
3 Re5+		Kh4
If 3 ... Kg6 4 Rg5+, Kxf7 (or   4 ... Kh7 5 Rh5+ and 6 Rh1) 5 Rf5+, Kg6 6 Kg4, and the Pawn is stopped dead in its tracks.
4 Ng5!
Lets Black Queen with check!
4 ...	f1=Q+
Black can be coy and play 4 ... 
Kh5 instead, when the right procedure is 5 Ne4+, Kh4 6 Nd2 (but not 6 Nxf2 stalemate) and. White wins.
5 Nf3+		Kh3
6 Rh5+		Kg2
7 Rh2#
###291
NO LONG-DRAWN out battle this. White disposes of his opponent with four vigorous moves.
1 Rh8+		Kg5
The alternative is 1 ... Kg4, when 2 Nf6+ wins the Queen by discovered attack.
2 Nd6		Qc6
Now the Queen is held to one move, the capture 2 ... Qxh8 being met by 3 Nf7+ winning the Queen.
3 Nf7+		Kf4
What else is there? If 3 ... Kg6 (or Kf6) 4 Rh6+ wins the Queen, or if 3 ... Kg4 4 Ne5+ does likewise.
4 Rh4#!
A problem-like mating position
###292
WHITE plays a combination designed to win the Queen. The tactical tricks making up the combination are the Pin, the Double Attack, and the Knight Fork, demonstrated by the Rook, the Pawn and the Knight respectively.
1 Ra4+	Ke5
On 1 ... Kc5 2 Ra5+ wins the Queen at once.
2 Ra5	c5
...
White wins the Queen and the game.
###293
DESPITE her great mobility, the Queen is caught and subdued by the Knight and Rook working together in perfect harmony.
1 Rc8                Qa3
If 1 ... Qxc8 (or 1... Qf7) 2 Nd6+ wins the Queen.
2 Nd4+    Kb6
The only flight square, as moving to the Rook file loses the Queen by 3 Ra8+.
3 Rb8+    Kc5

The alternatives 3 ... Kc7 or 3 ... Ka7 let King and Queen fall into the Knight's clutches by 4 Nb5+.
4 Rb5+        Kd6
5 Rd5+        Ke7
Here too 5 ... Kc7 is met by 6 Nb5+.
6 Ra5!
Shifting the attack to the Queen.
6 ...        Qxa5
It is either this, or 6... Qd6 when 7 Nf5+, or.
7 Nc6+
In both cases White wins the Queen and the game.
###294
1 b7!
WHITE begins with a powerful threat: 2 Ra8, pinning the Queen.
1 ... 		Kf7
The best defense, 1... Bxd6 coming to grief after 2 Ra8, Kf7 (if 2 ... Ke7 simply 3 Rxb8 wins) 3 Bxd6, Qxb7 (on 3... Qxd6 4 b8=Q wins) 4 Rf8#, while if 1 ... Qxb7 2 d7+, Kf7 3 d8=N+, and King and Queen are impaled.
2 Ra8		Qxb7
3 Rf8+!		Kxf8+
4 d7+		Kf7
Unpins the Pawn, which can now advance.
5 d8=N+!
Definitely not 5 d8=Q, when Black wins by 5 ... Qb1+ 6 Kh8, Qh1#.
5 ...		Ke8
6 Nxb7
White wins
###295
CHESS can never fail to be exciting as long as the lesser force outwits the greater.
1 Rh5+        Ke6!
Best, as 1 . . f5 allows the brutal continuation 2 Rxf5+, Qxf5 3 Bxf5, Kxf5, and White wins an easy Pawn ending, while 1 ... Kd4 2 e3+ is of course unthinkable.
2 Bb3+        d5
3 Rxd5
Threatens to discover check, and win the Queen. If for example, Black plays 3 ... Qxb4 4 Rxb5 wins for White.
3 ...        Qxf2
To which White cannot reply 4 Rf5+, as Black simply captures by 4 ... Kxf5.
4 d4!
Now the idea is to continue with 5 Re5+, Kd6 6 Re6#. 

4 ...         f5
Clears a flight square for the King at f6.
5 e4        Qxb2
If instead 5 ... fxe4 6 Rd8+, Kf6 (or Kf5) 7 Rf8+ and White wins the Queen.
Despite the fact that Black's Queen is out of danger (even to the point that she threatens the Bishop) White engineers a sparkling finale.
6 Rd6+!        Kxd6
7 e5+        Kc6
8 d5#!
###296
...
1...		Kc6
2 Kc8
Renews the mate threat.
2 ... 		Kd6
3 Kd8		Ke6
If the King returns, then this happens: 3 .. . Kc6 4 Rc8+, Kb7 (on 4 ... Kb6 5 Rxa2, b1=Q 6 Rb8+ wins the Queen) 5 Rb5+, Ka7 (or 5 ... Ka6 6 Rxb2, a1=Q 7 Ra8#) 6 Kc7 (threatens 7 Ra5#) a1=Q 7 Rb7+, Ka6 8 Ra8#.

Another possibility is 3... Kc6 4 Rc8+, Kd6 5 Rac5, Ke6 6 Ke8, Kf6 7 R8c6+, Kg7 8 Rg5+, Kh7 9 Kf7, b1=Q 10 Rh5#.
4 R8a6+		Kf7
5 Rf5+		Kg7
6 Rg5+		Kf7
Here if 6 ... Kh7 7 Rxa2, b1=Q 8 Rh2#
7 Rg6		b1=Q
8 Rf6#
###297
WHITE'S every move must be a hammer blow, or else the Queen will wrest the attack from him.
1 Ra4+		Kg5
2 Rc5+		Kf6
3 Ra6+		Ke7
The King must come closer to the Rooks, as 3 ... Kf7 instead is fatal after 4 Rc7+ followed by 5 Ra8+.
4 Rc7+	Kd8
5 Rch7
Attacks the Queen, and also threatens 6 Raa8#.
5 ...	Qg2
If instead 5 ... Qxh7 6 Ra8+, Kc7 7 Ra7+ wins the Queen.
6 Raa8+	Qxa8
7 Rh8+
White wins the Queen and the game.
###298
NO LESS than three out of the four Rooks are sacrificed before White can chalk up a victory.
1 Re1+		Kf5
2 Rxe7
Wins a Rook, but it's only for a moment.
2 ...		Kf6
Attacks the Rook while threatening mate on the move.
3 Rf7+!		Kxf7
4 b7		Rf6+
So that the Rook can gain time to get behind the Pawn.
5 Kh7 		Rb6
The alternative 5... Rf5 (threatening mate) succumbs to 6 Rf2!, Rxf2 7 b8=Q, and Black has no mate at h7, since White's Queen controls that square.
6 Ra7
Now Black must guard against     7 b8=Q+, followed by 8 Qxb6.
6 ...		Ke6
If the King moves to the first rank instead, say by 6... Ke8, simply 7 Ra8+ followed by Queening the Pawn wins for White.
7 Ra6!
Pins the Black Rook, thereby removing its pressure on the Pawn.
7 ...		Rxa6
8 b8=Q
White wins
###299
KNIGHTS were never more agile than these Rooks, who drive the King out into the open and weave a mating net around him.
1 Rf5+	    Ke8
2 Re7+	    Kd8
3 Rd7+	    Kc8
Black has no chance after 3 ... Ke8, when 4 Ra5, R3g6+ 5 Kc7 leaves him helpless to avert the mate at a8.
4 Rc5+	Kb8
5 Rb5+	Ka8
If 5 ... Kc8 instead, 6 Rc7+, Kd8 7 Rb8#.
6 Kc7
Threatens 7 Ra5#.
6 ...		R3g5
On 6 ... R8g5 instead, White mates in three, beginning with 7 Rd8+.
7 Rd8+		Ka7
Or 7 ... Rxd8 8 Rxg5, and Black must give up his remaining Rook to prevent mate.
8 Rb7+		Ka6
9 Rd6+		Ka5
10 Ra7+		Kb5
11 Rb6+		Kc5
...
And Black’s Rooks sit idle.
###300
WITH his pieces so widely scattered, and threatened with capture as well, how can White hope to win?
Strangely enough, though all his pieces are removed by capture, White does manage to force a win.
1 Be5+!		Kxe5
On 1 ... Kxg6 instead, the reply 2 Bc2+ wins the Rook.
2 g7		Rb8
3 Bb3!
Threatens to Queen the Pawn next move.
3 ...		Rxb3+
This looks good, as the Bishop is captured with check.
4 Nf3+!
Now Black is in check, and has no time to bring his Rook back to b8.
4 ... 		Rxf3+
5 Kg2!
The Rook has been lured to this square by two successive sacrifices and can no longer stop the Pawn from Queening.
White wins
###
`
